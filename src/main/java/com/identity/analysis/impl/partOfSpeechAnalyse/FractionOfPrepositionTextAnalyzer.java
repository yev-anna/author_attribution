...
import com.identity.entity.measures.impl.fractionOfPOS.FractionOfPreposition;
 ...
 */
public class FractionOfPrepositionTextAnalyzer extends FractionOfPOSTextAnalyzer<FractionOfPreposition> {
    @Override
    public Measure getMeasure(List<String> texts) {
        ...
        return new FractionOfPreposition(TextAnalyzer.expectedValue(texts, res));
    }

    @Override
    public double analyse(String text) {
        return analyse(text, PartOfSpeech.PREP);
    }
}

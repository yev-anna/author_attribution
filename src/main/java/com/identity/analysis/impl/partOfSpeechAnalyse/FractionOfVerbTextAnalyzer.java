 ...
 */
public class FractionOfVerbTextAnalyzer extends FractionOfPOSTextAnalyzer<FractionOfVerb>{
    @Override
    public Measure getMeasure(List<String> texts) {
        ...
        return new FractionOfVerb(TextAnalyzer.expectedValue(texts, res));
    }

    @Override
    public double analyse(String text) {
        return analyse(text, PartOfSpeech.VERB);
    }
}

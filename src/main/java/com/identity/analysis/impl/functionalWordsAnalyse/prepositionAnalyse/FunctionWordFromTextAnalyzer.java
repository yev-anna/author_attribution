...
import com.identity.entity.measures.impl.functionalWords.preposition.FunctionWordFrom;
 ...
 */
public class FunctionWordFromTextAnalyzer extends FunctionWordTextAnalyzer<FunctionWordFrom> {
    ...
    public Measure getMeasure(List<String> texts) {
        ...
        return new FunctionWordFrom(TextAnalyzer.expectedValue(texts, res));
    }

    @Override
    public double analyse(String text) {
        return analyse(text, "from");
    }
}

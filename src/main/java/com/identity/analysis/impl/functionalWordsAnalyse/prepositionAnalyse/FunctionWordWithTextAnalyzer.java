...
import com.identity.entity.measures.impl.functionalWords.preposition.FunctionWordWith;
 ...
 */
public class FunctionWordWithTextAnalyzer extends FunctionWordTextAnalyzer<FunctionWordWith> {
    ...
    public Measure getMeasure(List<String> texts) {
        ...
        return new FunctionWordWith(TextAnalyzer.expectedValue(texts, res));
    }

    @Override
    public double analyse(String text) {
        return analyse(text, "with");
    }
}
